...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("GET /", s.defaultLocalized(s.handleHome))
	...
	s.mux.HandleFunc("GET /kept", s.handleKept)
	s.mux.HandleFunc("POST /keep/{id}", s.handleKeep)
	s.mux.HandleFunc("POST /unkeep/{id}", s.handleUnkeep)
	...
	s.mux.HandleFunc("GET /inbox/{id}/reply", s.handleReplyForm)
	s.mux.HandleFunc("POST /inbox/{id}/reply", s.handleCreateReply)
	s.mux.HandleFunc("POST /inbox/{id}/close", s.handleCloseCorrespondence)
